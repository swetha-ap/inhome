...
<div class="container" style=" background-image: url('images/bg.jpg'); height: 700px;">
    <div class="row">
        <div class="col" style="height: 50px;"></div>
    </div>
    <div class="row  d-flex justify-content-center align-items-center ">
        <div class="col">
            <h1 style="color: white;" align="center">BE THE SERVICE PROVIDER</h1>
        </div>
    </div>
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col-12">
            <div class="  cardsh opacity-20" >
                <div class="card-body cardsh ">
                <div class="row">
                    <div class="col-6">
                        <form>
