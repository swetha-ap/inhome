        ...
        <div class="col-md-5">
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12"><label class="labels">Years of Experience</label><input type="text" class="form-control"
                        placeholder="enter years of experience" value=""></div><br />
                    <div class="col-md-12"><label class="labels">Salary</label><input type="text" class="form-control"
                        placeholder="enter salary" value=""></div><br />
