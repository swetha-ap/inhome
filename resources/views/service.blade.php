...
<div class="container-fluid bgimg1" style="height:900px; ">
     <div class="row ">
          ...
          <div class="col-12" style="height: 100px;">
               <h1 align="center" style="font-family: cursive; color: rgb(209, 46, 5);">We Provide You with the Best Of
                    Best</h1>
          </div>
     </div>
     <div class="row">
          ...
          <div class="col-3" style="display:inline-block; height:300px;">
               <div class="card" style="width: 18rem;height: 530px;">
                    ...
                    <div class="card-body ">
                         ...
                         <h5 class="card-text" style="color: darkblue;">Everyone dreams of a clean home.<br />We Clean
                              so you dont have to!!!</h5>
          ...
          <div class="col-3" style="display:inline-block; height:300px;">
               <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                         ...
                         <h5 class="card-text" style="color: darkmagenta;">Need a break? Some Quality time for
                              yourselves? <br />A Reliable Caring Nanny is just a Click Away!!!</h5>
                         <a href="{{ route ('login') }}" class="btn btn-primary">Book Now</a>
                    </div>
               </div>
          </div>
          ...
          <div class="col-3" style="display:inline-block; height:300px;">
               <div class="card" style="width: 18rem; height: 530px;">
                    ...
                    <div class="card-body">
                         ...
                         <h5 class="card-text" style="color: darkred;">Help Us Help You!!!<br />Fill your Heart and Soul
                              with Yumminess!!! </h5>
                         <a href="{{ route ('login') }}" class="btn btn-primary">Book Now</a>
                    </div>
               </div>
